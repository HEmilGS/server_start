...
router.post('/:user_id', feedBackController.createFeedBack); //we set as the root of the route the function createUser from the userController because we want to create a new user in the database
